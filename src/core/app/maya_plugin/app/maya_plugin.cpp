...
struct WGTHideCommand : public MTemplateAction<WGTHideCommand, WGT_MAYA_COMMAND_HIDE, MTemplateCommand_nullSyntax>
{
	MStatus doIt(const MArgList& args) override;
};
...
struct WGTStartCommand : public MTemplateAction<WGTStartCommand, WGT_MAYA_COMMAND_START, MTemplateCommand_nullSyntax>
{
	MStatus doIt(const MArgList& args) override;
};
...
struct WGTStopCommand : public MTemplateAction<WGTStopCommand, WGT_MAYA_COMMAND_STOP, MTemplateCommand_nullSyntax>
{
	MStatus doIt(const MArgList& args) override;
};
