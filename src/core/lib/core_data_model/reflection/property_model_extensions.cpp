...
public:
    ...
    bool setValue(RefPropertyItem*, int, ItemRole::Id, const Variant&, IDefinitionManager&, ICommandManager&) const override
    {
        return false;
    }
};
...
Variant SetterGetterExtension::getValue(const RefPropertyItem * item, int column, ItemRole::Id roleId, IDefinitionManager & definitionManager) const
{
    return getNext<SetterGetterExtension>()->getValue(item, column, roleId, definitionManager);
}

bool SetterGetterExtension::setValue(RefPropertyItem* item, int column, ItemRole::Id roleId, const Variant& data, IDefinitionManager& definitionManager, ICommandManager& commandManager) const
{
