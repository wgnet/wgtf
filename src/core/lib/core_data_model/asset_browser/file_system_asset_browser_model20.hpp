...
private:
	...
	virtual void populateFolderContents(AbstractItem* item) override;
	...
	virtual AbstractListModel* getFolderContents() const override;

	virtual AbstractTreeModel* getFolderTreeModel() const override;
