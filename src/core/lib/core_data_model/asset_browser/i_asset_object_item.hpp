...
public:
	...
	virtual Variant getData(int column, ItemRole::Id roleId) const override = 0;
	virtual bool setData(int column, ItemRole::Id roleId, const Variant& data) override = 0;

	// IAssetObjectItemOld Methods for Tree Model Usage
