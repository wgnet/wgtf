...
{
	Implementation(TestStringData& self) : self_(self), state_(STATE_LIST), position_(0)
	{
	}
	...
	void initialise(State state)
	{
		...
		*/
		...
		case STATE_TREE:
		{
			rawTreeData_ = "Animations Monsters anim_bear anim_mouse anim_rat Landscape anim_dirt anim_rock anim_water "
			               "Dancing crazy_dance happy_dance fancy_dance ";
			rawTreeData_ += "Objects Generic object_01 objects_02 object_03 Magical object_04 object_05 object_06 "
			                "Mechanical object_07 object_08 object_09 ";
			rawTreeData_ += "Models Enemies model_skeleton model_wizard model_ogre Small model_bat model_ant model_rat "
			                "Large model_truck model_troll model_dinosaur ";
...
TestStringData::TestStringData() : impl_(new Implementation(*this))
{
}
