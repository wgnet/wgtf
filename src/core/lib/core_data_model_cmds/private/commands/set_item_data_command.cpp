...
SetItemDataCommand::SetItemDataCommand(IComponentContext& context) : definitionManager_(context)
{
}
...
ObjectHandle SetItemDataCommand::execute(const ObjectHandle& arguments) const /* override */
{
	auto pCommandArgs = arguments.getBase<SetItemDataCommandArgument>();
	if (!SetItemDataCommand_Detail::isValid(pCommandArgs))
	{
