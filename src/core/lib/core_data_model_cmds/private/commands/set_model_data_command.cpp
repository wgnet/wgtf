...
SetModelDataCommand::SetModelDataCommand( IComponentContext & context )
...
ObjectHandle SetModelDataCommand::getCommandDescription(
...
bool SetModelDataCommand::validateArguments(
	const ObjectHandle & arguments ) const /* override */
{
...
ObjectHandle SetModelDataCommand::execute(
	const ObjectHandle & arguments ) const /* override */
{
	auto pCommandArgs = arguments.getBase< SetModelDataCommandArgument >();
	if (!SetModelDataCommand_Detail::isValid(pCommandArgs))
