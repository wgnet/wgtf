...
namespace Detail
{
bool isValid( const ItemDataCommandArgument * pCommandArgs )
{
...
bool SetItemDataCommand::undo( const ObjectHandle & arguments ) const /* override */
{
	...
	auto pCommandArgs = arguments.getBase< ItemDataCommandArgument >();
	if (!Detail::isValid( pCommandArgs ))
	{
		return false;
	}
...
bool SetItemDataCommand::validateArguments(
	const ObjectHandle & arguments ) const /* override */
{
	const auto pCommandArgs = arguments.getBase< ItemDataCommandArgument >();
	return Detail::isValid( pCommandArgs );
}
