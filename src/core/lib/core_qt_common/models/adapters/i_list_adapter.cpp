...
void IListAdapter::reset()
    ...
    void IListAdapter::connect()
    {
	    ...
	    this, &IListAdapter::onParentRowsAboutToBeMoved);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::rowsMoved,
	    this, &IListAdapter::onParentRowsMoved);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::columnsAboutToBeInserted,
	    this, &IListAdapter::onParentColumnsAboutToBeInserted);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::columnsInserted,
	    this, &IListAdapter::onParentColumnsInserted);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::columnsAboutToBeRemoved,
	    this, &IListAdapter::onParentColumnsAboutToBeRemoved);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::columnsRemoved,
	    this, &IListAdapter::onParentColumnsRemoved);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::columnsAboutToBeMoved,
	    this, &IListAdapter::onParentColumnsAboutToBeMoved);
	    connections_ += QObject::connect(
	    model, &QAbstractItemModel::columnsMoved,
	    this, &IListAdapter::onParentColumnsMoved);
    }
