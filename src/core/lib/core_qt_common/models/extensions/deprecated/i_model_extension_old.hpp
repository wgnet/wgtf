...
public slots:
	virtual void onDataAboutToBeChanged(const QModelIndex& index, int role, const QVariant& value)
	{
	}
	virtual void onDataChanged(const QModelIndex& index, int role, const QVariant& value)
	{
	}
