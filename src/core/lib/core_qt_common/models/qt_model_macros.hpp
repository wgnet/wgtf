...
#define EVENT_DECL(InterfaceName)                                                                                \
	void onPreItemDataChanged(const InterfaceName* sender, const InterfaceName::PreItemDataChangedArgs& args);   \
	void onPostItemDataChanged(const InterfaceName* sender, const InterfaceName::PostItemDataChangedArgs& args); \
	void onPreItemsInserted(const InterfaceName* sender, const InterfaceName::PreItemsInsertedArgs& args);       \
	void onPostItemsInserted(const InterfaceName* sender, const InterfaceName::PostItemsInsertedArgs& args);     \
	void onPreItemsRemoved(const InterfaceName* sender, const InterfaceName::PreItemsRemovedArgs& args);         \
	void onPostItemsRemoved(const InterfaceName* sender, const InterfaceName::PostItemsRemovedArgs& args);       \
	void onDestructing(const InterfaceName* sender, const InterfaceName::DestructingArgs& args);
