/* Modified version of Qt\5.6\Src\qtbase\src\corelib\itemmodels\qsortfilterproxymodel.h */
...
#ifndef WGT_QSORTFILTERPROXYMODEL_H
#define WGT_QSORTFILTERPROXYMODEL_H
