...
WGTokenizedStringFilter::Implementation::Implementation(WGTokenizedStringFilter& self) : self_(self)
{
}
...
WGTokenizedStringFilter::WGTokenizedStringFilter() : impl_(new Implementation(*this))
{
}
