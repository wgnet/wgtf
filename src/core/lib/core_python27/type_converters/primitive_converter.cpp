...
{
template <typename T>
bool PrimitiveConverter<T>::toVariant(const PyScript::ScriptObject& inObject, Variant& outVariant) /* override */
{
	T value;
...
template <typename T>
bool PrimitiveConverter<T>::toScriptType(const Variant& inVariant, PyScript::ScriptObject& outObject,
