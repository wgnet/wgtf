...
{
//------------------------------------------------------------------------------
BinaryBlock::BinaryBlock() : data_(nullptr), length_(0), externallyOwned_(false)
{
}

//------------------------------------------------------------------------------
BinaryBlock::BinaryBlock(const void* data, size_t len, bool externallyOwned)
    : data_(nullptr), length_(len), externallyOwned_(externallyOwned)
{
...
BinaryBlock::BinaryBlock(const BinaryBlock& that)
    : data_(nullptr), length_(that.length_), externallyOwned_(that.externallyOwned_)
{
	if (externallyOwned_)
	{
		data_ = that.data_;
...
BinaryBlock::BinaryBlock(BinaryBlock&& that)
    : data_(that.data_), length_(that.length_), externallyOwned_(that.externallyOwned_)
{
