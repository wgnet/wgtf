...
ReflectedMethodParameters::ReflectedMethodParameters() : impl_(new Implementation(*this))
{
}

ReflectedMethodParameters::ReflectedMethodParameters(const Variant& variant) : impl_(new Implementation(*this))
{
...
ReflectedMethodParameters::const_iterator ReflectedMethodParameters::const_iterator::operator+(difference_type n) const
{
