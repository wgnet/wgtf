...
#define RM_PARAMETER_1(macro) \
	RM_PARAMETER_0(macro)     \
	, macro(1)
#define RM_PARAMETER_2(macro) \
	RM_PARAMETER_1(macro)     \
	, macro(2)
#define RM_PARAMETER_3(macro) \
	RM_PARAMETER_2(macro)     \
	, macro(3)
#define RM_PARAMETER_4(macro) \
	RM_PARAMETER_3(macro)     \
	, macro(4)
#define RM_PARAMETER_5(macro) \
	RM_PARAMETER_4(macro)     \
	, macro(5)
#define RM_PARAMETER_6(macro) \
	RM_PARAMETER_5(macro)     \
	, macro(6)
#define RM_PARAMETER_7(macro) \
	RM_PARAMETER_6(macro)     \
	, macro(7)
#define RM_PARAMETER_8(macro) \
	RM_PARAMETER_7(macro)     \
	, macro(8)
#define RM_PARAMETER_9(macro) \
	RM_PARAMETER_8(macro)     \
	, macro(9)

#define RM_PARAMETER_WITH_PREFIX_NONE(prefix, ...) prefix()
#define RM_PARAMETER_WITH_PREFIX_0(prefix, macro) prefix(), macro(0)
#define RM_PARAMETER_WITH_PREFIX_1(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_0(prefix, macro)     \
	, macro(1)
#define RM_PARAMETER_WITH_PREFIX_2(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_1(prefix, macro)     \
	, macro(2)
#define RM_PARAMETER_WITH_PREFIX_3(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_2(prefix, macro)     \
	, macro(3)
#define RM_PARAMETER_WITH_PREFIX_4(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_3(prefix, macro)     \
	, macro(4)
#define RM_PARAMETER_WITH_PREFIX_5(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_4(prefix, macro)     \
	, macro(5)
#define RM_PARAMETER_WITH_PREFIX_6(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_5(prefix, macro)     \
	, macro(6)
#define RM_PARAMETER_WITH_PREFIX_7(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_6(prefix, macro)     \
	, macro(7)
#define RM_PARAMETER_WITH_PREFIX_8(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_7(prefix, macro)     \
	, macro(8)
#define RM_PARAMETER_WITH_PREFIX_9(prefix, macro) \
	RM_PARAMETER_WITH_PREFIX_8(prefix, macro)     \
	, macro(9)

#define RM_STATEMENT_NONE(...)
#define RM_STATEMENT_0(macro) macro(0)
#define RM_STATEMENT_1(macro) \
	RM_STATEMENT_0(macro)     \
	\
macro(1)
#define RM_STATEMENT_2(macro) \
	RM_STATEMENT_1(macro)     \
	\
macro(2)
#define RM_STATEMENT_3(macro) \
	RM_STATEMENT_2(macro)     \
	\
macro(3)
#define RM_STATEMENT_4(macro) \
	RM_STATEMENT_3(macro)     \
	\
macro(4)
#define RM_STATEMENT_5(macro) \
	RM_STATEMENT_4(macro)     \
	\
macro(5)
#define RM_STATEMENT_6(macro) \
	RM_STATEMENT_5(macro)     \
	\
macro(6)
#define RM_STATEMENT_7(macro) \
	RM_STATEMENT_6(macro)     \
	\
macro(7)
#define RM_STATEMENT_8(macro) \
	RM_STATEMENT_7(macro)     \
	\
macro(8)
#define RM_STATEMENT_9(macro) \
	RM_STATEMENT_8(macro)     \
	\
macro(9)
...
#define RM_CLASS_PARAMETERS(n)            \
	RM_JOIN(RM_PARAMETER_WITH_PREFIX_, n) \
	(RM_CLASS_PARAMETER_PREFIX, RM_CLASS_PARAMETER)
#define RM_CLASS_PARAMETERS_PASSED(n) \
	RM_JOIN(RM_PARAMETER_, n)         \
	\
(RM_CLASS_PARAMETER)
...
#define RM_CLASS_PARAMETERS_WITH_DEFAULTS(n) \
	RM_JOIN(RM_PARAMETER_WITH_PREFIX_, n)    \
	(RM_CLASS_PARAMETER_PREFIX, RM_CLASS_PARAMETER_WITH_DEFAULTS)

#define RM_PLAIN_PARAMETER_PREFIX() ClassType, ReturnType
#define RM_PLAIN_PARAMETERS(n)            \
	RM_JOIN(RM_PARAMETER_WITH_PREFIX_, n) \
	(RM_PLAIN_PARAMETER_PREFIX, RM_PLAIN_PARAMETER)
#define RM_PLAIN_PARAMETERS_PASSED(n) \
	RM_JOIN(RM_PARAMETER_, n)         \
	\
(RM_PLAIN_PARAMETER)
...
#define RM_PASS_PARAMETERS(n)             \
	RM_JOIN(RM_PARAMETER_WITH_PREFIX_, n) \
	\
(RM_PASS_PARAMETER_PREFIX,                \
	RM_PASS_PARAMETER)
...
ReflectedMethodParameterWrapper<typename std::decay<Parameter##n##Type>::type, \
	                            std::is_reference<Parameter##n##Type>::value>  \
	p##n(parameters[n], definitionManager);

#define RM_EXTRACT_PARAMETER_LINES(n) \
	RM_JOIN(RM_STATEMENT_, n)         \
	\
(RM_EXTRACT_PARAMETER_LINE)

#define RM_METHOD_SPECIALISATION_BEGIN_DEFAULT(n)   \
	template <RM_CLASS_PARAMETERS_WITH_DEFAULTS(n)> \
	struct ReflectedMethodSpecialisation RM_METHOD_SPECIALISATION_BEGIN_BODY(n)

#define RM_METHOD_SPECIALISATION_BEGIN(n) \
	template <RM_CLASS_PARAMETERS(n)>     \
	struct ReflectedMethodSpecialisation<RM_PLAIN_PARAMETERS(n)> RM_METHOD_SPECIALISATION_BEGIN_BODY(n)
	...
	{                                                                                                           \
		...
		{                                                                                                       \
			undoMethod_.reset(undoMethod ?                                                                      \
			                  new ReflectedMethodSpecialisation<ClassType, void, const ObjectHandle&, Variant>( \
...
#define RM_FACTORY_CREATE_METHOD(n)                                                                             \
	...
	const char* name, ReturnType (ClassType::*method)(RM_PLAIN_PARAMETERS_PASSED(n)),                           \
