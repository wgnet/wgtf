...
public:
	 ...
	 */
	virtual ObjectHandle createObject(const RefObjectId& id, const std::string& classDef) const = 0;
	 ...
	 *	@return new object.
	 */
	virtual ObjectHandle create(const std::string& classDef) const = 0;
	 ...
	 */
	virtual bool getContextObjects(IDefinitionManager* context, std::vector<RefObjectId>& o_objects) const = 0;
	 ...
	 */
	virtual ObjectHandle registerObject(ObjectHandle& pObj, const RefObjectId& id = RefObjectId::zero()) = 0;
	 ...
	 *	@return the registered object.
	 */
	virtual RefObjectId registerUnmanagedObject(const ObjectHandle& object,
