...
namespace wgt
{
MetaHandle findFirstMetaData(const TypeId& typeId, const MetaHandle& metaData,
...
MetaHandle findFirstMetaData(const TypeId& typeId, const PropertyAccessor& accessor,
                             const IDefinitionManager& definitionManager)
{
	...
	if (!parentAccessor.canGetValue() || parentAccessor.getValue().typeIs<Collection>() == false)
	{
		return nullptr;
	}
...
MetaHandle findFirstMetaData(const TypeId& typeId, const IBaseProperty& pProperty,
                             const IDefinitionManager& definitionManager)
{
...
MetaHandle findFirstMetaData(const TypeId& typeId, const IClassDefinition& definition,
                             const IDefinitionManager& definitionManager)
{
