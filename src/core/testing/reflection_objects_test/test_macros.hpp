...
#define GENERATE_COL_NAME( prefix, name, postFix )\
...
#define INIT_COLLECTION_DATA( definitionManager, DataType, name, prefix )\
	TestObjectCommon::populateData< DataType >(\
		definitionManager, GENERATE_COL_NAME( prefix, name, col_std ) );\
	//TestObjectCommon::populateData< DataType >(\
	//	definitionManager, GENERATE_COL_NAME( prefix, name, col_bw ) );

#define INIT_COL_PRE( definitionManager )\
	INIT_COL_PRE_( definitionManager, )

#define INIT_COL_PRE_DERIVED( definitionManager )\
	INIT_COL_PRE_( definitionManager, Derived )
