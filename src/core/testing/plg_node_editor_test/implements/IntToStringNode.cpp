...
, m_y(0.0f)
, m_class(nodeClass)
, m_title(INT_TO_STRING_NODE_TITLE)
, m_subTitle(INT_TO_STRING_NODE_SUBTITLE)
, m_icon(INT_TO_STRING_NODE_ICON)
, m_color(INT_TO_STRING_NODE_COLOR)
, m_enabled(true)
, m_minimized(false)
{
    ...
    m_inputSlotsModel.back()->setLabel("a");
    m_outputSlotsModel.push_back(new StringSlot(this, false));
