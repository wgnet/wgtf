...
public:
	//==========================================================================
	TableModelTestPlugin(IComponentContext & contextManager )
	...
	void Initialise( IComponentContext & contextManager )
	{
		...
		if (viewCreator)
		{
			tableView_  = viewCreator->createView(
				"plg_table_model_test/test_table_panel.qml",
				tableModel_ );
		}
	}
