...
public:
	...
	*/
	virtual void redo(Variant params, Variant variant) = 0;

	/*! Undoes the last modification
	*/
	virtual void undo(Variant params, Variant variant) = 0;

	virtual bool getDirty() const = 0;

	virtual void getDirtySignal(Signal<void(Variant&)>**) const = 0;

protected:
	/*! Gets the collection of bezier points exposed through reflection
	*/
	virtual const AbstractListModel* getPoints() const = 0;
