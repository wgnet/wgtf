...
#define CONNECTION_ROUNDING 5 * m_contentScale
	...
	painter->setPen(QPen(maskColor, 4 * m_contentScale, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin));
	painter->drawPath(path);

	painter->setPen(QPen(m_color, 2 * m_contentScale, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin));
	painter->drawPath(path);
