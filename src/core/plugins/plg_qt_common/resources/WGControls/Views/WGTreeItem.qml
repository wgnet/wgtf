...
\endcode
    ...
    \todo This needs to be tested with a tree with multiple root nodes
*/

ListView {
    id: treeItem
    objectName: typeof(itemData) != "undefined" ? itemData.indexPath : "WGListView"
    WGComponent { type: "WGTreeItem" }
                ...
                Component { // Row contents, icons and columns
                    ...
                    Item {
                        ...
                        Loader {
                            ...
                            onLoaded: {
                                if ( typeof(item.mimeKeys) !== "undefined" && typeof(item.mimeData) !== "undefined" )
                                {
                                    rowDelegate.dragItem.Drag.mimeKeys = Qt.binding(function(){return item.mimeKeys;});
                                    rowDelegate.dragItem.Drag.mimeData = Qt.binding(function(){return item.mimeData;});
                                }
