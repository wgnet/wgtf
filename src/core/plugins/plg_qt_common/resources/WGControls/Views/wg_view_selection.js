...
function updateSelection(event, selectionModel, extension, rowIndex) {
    var selection;
    if ((event !=null) && (event.modifiers & Qt.ShiftModifier) && (event.modifiers & Qt.ControlModifier)) {
    ...
    else if ((event !=null) && event.modifiers & Qt.ShiftModifier) {
        selection = extension.itemSelection(selectionModel.shiftIndex, rowIndex)
    ...
    else if ((event !=null) && event.modifiers & Qt.ControlModifier) {
