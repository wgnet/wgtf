...
import WGControls 2.0 as WGControls
...
Rectangle {
    id: timelineFrame
    WGComponent { type: "WGTimelineControl20" }
    ...
    ColumnLayout {
        ...
        WGGridCanvas {
            ...
            WGSlider {
                ...
                WGSliderHandle {
                    showBar: false
                    handleStyle: WGControls.WGButtonFrame {
                        id: scrubberHandle
            ...
            ListView {
                ...
                delegate: Loader {
                    ...
                    property Component textObject: WGControls.WGTextBox {
                        id: textObject
                        text: model.text
                        onEditAccepted: {
                            model.text = text;
                    ...
                    property Component fullBar: WGControls.WGButtonFrame {
                        id: fullBar
        ...
        WGTimelineBarSlider {
            ...
            style: WGSliderStyle {
                groove: WGControls.WGTextBoxFrame {
                    radius: defaultSpacing.standardRadius
