...
def main():
  ...
  p.add_argument('--skip_merge', action='count', default=0,
				help='skip formatting if a merge commit')
  ...
  if opts.skip_merge:
    if commit_is_merge(commit):
	  print 'skipping formatting merge commit'
	  return
