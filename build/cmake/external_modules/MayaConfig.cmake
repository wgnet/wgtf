...
IF( NOT Maya_FIND_VERSION )
    SET( Maya_FIND_VERSION "2014" )
ENDIF()

SET (MAYA_FILES ${WG_TOOLS_THIRD_PARTY_DIR}/Maya)
SET (MAYA_DIRECTORY ${MAYA_FILES}/${Maya_FIND_VERSION})

SET( MAYA_DEVKIT_DIR ${MAYA_DIRECTORY} )
...
IF( NOT EXISTS "${MAYA_FILES}" )
IF( NOT EXISTS ${Maya_URL} )
	SET(Maya_SUPPORT FALSE)
ENDIF()
ENDIF()

IF (NOT Maya_SUPPORT)
	SET(MAYA_FOUND FALSE)
	SET(MAYA_EXISTS FALSE)
	SET(MAYA_THIRD_PARTY_NOT_FOUND TRUE )
	RETURN()
ENDIF()


IF ( NOT EXISTS ${MAYA_EXECUTABLE} )
	FILE( REMOVE_RECURSE "${WG_EXTERNAL_PROJECTS_ROOT}/Maya" )
	IF( ${CMAKE_VERSION} VERSION_GREATER "3.5")
		WG_FETCH_EXTERNAL_PACKAGE( Maya ${Maya_FIND_VERSION}
			GIT_REPOSITORY ${Maya_URL}
			CONFIGURE_COMMAND ""  
			BUILD_COMMAND "" 
			INSTALL_COMMAND "" 
			GIT_SHALLOW 1
			SOURCE_DIR ${MAYA_FILES}
		)
	ELSE()
	WG_FETCH_EXTERNAL_PACKAGE( Maya ${Maya_FIND_VERSION}
			GIT_REPOSITORY ${Maya_URL}
...
# - Maya finder module
# Base on https://github.com/nerdvegas/vfxcmake/blob/master/cmake/FindMaya.cmake
#
...
MESSAGE( STATUS "MAYA_EXECUTABLE:${MAYA_EXECUTABLE}" )
if(MAYA_EXECUTABLE)
