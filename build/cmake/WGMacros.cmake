...
FUNCTION( BW_SET_PYTHON_EXTENSION_OUTPUT_DIR _PROJNAME _DIRNAME _PLATFORM )
	# See Script::init in pyscript/script.cpp
	IF( WIN32 )
		# On WIN32, debug modules have a _d suffix
		SET(MODULE_ROOT "${_DIRNAME}/scripts/client/DLLs/${_PLATFORM}")
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
		...
		# Hybrid and Consumer Release outputs will overwrite each other
		# This should be resolved by BWT-30783
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
		...
		LIST( FIND CMAKE_CONFIGURATION_TYPES "Consumer_Release" CONFIG_INDEX )
		IF( NOT ${CONFIG_INDEX} EQUAL -1 )
			SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
				RUNTIME_OUTPUT_DIRECTORY_CONSUMER_RELEASE "${MODULE_ROOT}"
				ARCHIVE_OUTPUT_DIRECTORY_CONSUMER_RELEASE "${MODULE_ROOT}"
				LIBRARY_OUTPUT_DIRECTORY_CONSUMER_RELEASE "${MODULE_ROOT}"
				)
		ENDIF()
	ELSE()
		SET(MODULE_ROOT "${_DIRNAME}/scripts/server_common/lib-dynload-${_PLATFORM}" )
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
		...
		IF( NOT ${CONFIG_INDEX} EQUAL -1 )
			SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
				RUNTIME_OUTPUT_DIRECTORY_CONSUMER_RELEASE
					"${MODULE_ROOT}_release"
				ARCHIVE_OUTPUT_DIRECTORY_CONSUMER_RELEASE
					"${MODULE_ROOT}_release"
				LIBRARY_OUTPUT_DIRECTORY_CONSUMER_RELEASE
					"${MODULE_ROOT}_release"
				)
		ENDIF()
	ENDIF()
